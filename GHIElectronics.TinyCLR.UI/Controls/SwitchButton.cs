...
namespace GHIElectronics.TinyCLR.UI.Controls {
    public class SwitchButton : ContentControl, IDisposable {
        ...
        private void InitResource() {
            this.bitmapImageButtonDown = BitmapImage.FromGraphics(Graphics.FromImage(Resources.GetBitmap(Resources.BitmapResources.ToggleDown)));
            this.bitmapImageButtonUp = BitmapImage.FromGraphics(Graphics.FromImage(Resources.GetBitmap(Resources.BitmapResources.ToggleUp)));
        }
